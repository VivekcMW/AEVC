      ...
      <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8 lg:py-20">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <div className="flex flex-col gap-6">
            <section>
              <h2 className="font-heading text-xl font-semibold text-ink">{t('cultureTitle')}</h2>
              <p className="mt-2 text-ink/75">{t('cultureBody')}</p>
            </section>

            <section>
              <h2 className="font-heading text-xl font-semibold text-ink">{t('openRolesTitle')}</h2>
              <p className="mt-2 text-ink/75">{t('openRolesBody')}</p>
            </section>
          </div>

          <EnquiryForm namespace="careers" message="Careers — general interest" />
        </div>
      </div>
    </>
  )
