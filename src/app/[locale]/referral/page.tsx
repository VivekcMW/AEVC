        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <div className="flex flex-col gap-6">
            ...
            <section className="rounded-lg border border-forest/12 bg-surface p-5">
              <h2 className="font-heading text-sm font-semibold tracking-[0.1em] text-ink/60 uppercase">
                {t('codeTitle')}
              </h2>
              <p className="mt-2 text-sm text-ink/75">{t('codeNote')}</p>
            </section>
          </div>

          <EnquiryForm namespace="referral" message="Referral programme early-access request" />
        </div>
      </div>
    </>
  )
